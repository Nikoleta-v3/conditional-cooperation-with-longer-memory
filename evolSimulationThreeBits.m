function [xDat]=evolSimulationThreeBits(N, c, b, beta, numberIterations, starting_resident, seed);
rng(seed)
...
%% Initialization
sdim=8;
xDat=zeros(numberIterations/100, 10);
xDat(1,:)=[Res, 0, 0];


u = repmat([b - c, -c, b, 0], 1, 16);
...
vMM=stationaryThreeBits(Mut, Mut);
vMR=stationaryThreeBits(Mut, Res);
vRM=stationaryThreeBits(Res, Mut);
vRR=stationaryThreeBits(Res, Res);

piMM=vMM*u';
coopMM=vMM(1) + vMM(5) + vMM(9) + vMM(13) + vMM(17) + vMM(21) + vMM(25) + vMM(29) + vMM(33) + vMM(37) + vMM(41) + vMM(45) + vMM(49) + vMM(53) + vMM(57) + vMM(61);
coopMM = coopMM + vMM(2) + vMM(6) + vMM(10) + vMM(14) + vMM(18) + vMM(22) + vMM(26) + vMM(30) + vMM(34) + vMM(38) + vMM(42) + vMM(46) + vMM(50) + vMM(54) + vMM(58) + vMM(62);
