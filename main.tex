...
Next we compare the evolutionary of partner strategies and the evolving
cooperation rates for different memory sizes whilst varying the selection
strength. To this end, we ran simulations for different $b/c$ ratios. As we
explore the impact of memory size on the evolution of partner strategies,
several patterns emerge. Increasing memory capacity tends to lead to higher
abundance of partner strategies, irrespective of the selection strength.
Notably, the highest abundance is observed for lower cost values. We observe
that the evolving cooperation rate curves align with the prevalence of partner
strategies. Thus, it is partner strategies that allow for the evolution of
cooperation, and as more memory selects partner strategies more often, the
cooperation rate also increases with memory. In contrast, when examining
