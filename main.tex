...
\begin{algorithm}[H]
  \SetAlgoLined \For{ $i <$ maximum number of points}{\(\mathbf{\hat{p}}\)
   ...
   \(p_1\)
   $\leftarrow$ 1\;
   $L(\mathbf{\hat{p}}) = \{\mathbf{\hat{q}} \,|\, \pi(\mathbf{\hat{p}}, \mathbf{\hat{p}}) \geq \pi(\mathbf{\hat{q}}, \mathbf{\hat{p}}) \text{ for } \mathbf{\hat{q}} \in \{\mathbf{\hat{q}_i} \in P([0, 1]) \,|\, |\mathbf{\hat{q}_i}| = 4 \}\}$\;
