...
In the following, we are particularly interested in those reactive-$n$ strategies that sustain full cooperation. 
...
For example, for the donation game, partners are those strategies with $p_C\!=\!1$ and $p_D\!\le\!1\!-\!c/b$~\citep{akin:EGADS:2016}. 
...
(Fig.~\ref{fig:conceptual_figure_results}A-B). 
Formally, a
...
Our result aligns with the findings
