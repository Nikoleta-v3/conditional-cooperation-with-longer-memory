...
$\mathbf{\hat{p}}=(r_0, r_1, r_2=1)$. Conditions~(\ref{eq:two_bit_conditions})
then become:

\begin{equation}\label{eq:counting_two_bit_conditions}
  \displaystyle r_2 < 1-\frac{c}{2b} ~~and~~ r_0 < 1\!-\! \frac{c}{b}.
\end{equation}
...
r_1, r_2, r_3=1)$. Then, conditions~(\ref{eq:three_bit_conditions}), the
